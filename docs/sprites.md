...
original connected 3D character. All modes retain Planck.js 2D physics,
...
The original model is generated by `src/avatar-geometry.ts` and rendered by
...
Paper Climber supplies eight original direction-tagged helmet views. They use
